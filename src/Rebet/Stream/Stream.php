        ...
        return [
            'filter' => [
                ...
                'customs' => [
                    ...
                    'if'       => function ($value, $test, $then, $else = null) { return  (is_bool($test) ? $test : $value === $test) ? $then : ($else ?? $value) ; },
                    'unless'   => function ($value, $test, $then, $else = null) { return !(is_bool($test) ? $test : $value === $test) ? $then : ($else ?? $value) ; },
