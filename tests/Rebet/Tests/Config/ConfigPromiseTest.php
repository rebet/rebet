...
class ConfigPromiseTest extends RebetTestCase {
    ...
    public function setUp() {
        \putenv('PROMISE_TEST=');
        Config::clear();
        $this->promise_once  = new ConfigPromise(function(){ return \getenv('PROMISE_TEST') ?: 'default'; });
        $this->promise_every = new ConfigPromise(function(){ return \getenv('PROMISE_TEST') ?: 'default'; }, false);
    }
