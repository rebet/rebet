...
class BuiltinFilesystemTest extends RebetTestCase
{
    ...
    {
        parent::setUp();
        $this->root       = App::path('resources/tests/Filesystem/BuiltinFilesystem');
    ...
    {
        $this->assertSame(App::path('resources/tests/Filesystem/BuiltinFilesystem/'), $this->filesystem->path());
        $this->assertSame(App::path('resources/tests/Filesystem/BuiltinFilesystem/hello.txt'), $this->filesystem->path('hello.txt'));
    }
    ...
    public function test_size()
    {
        ...
        $this->filesystem->put('72x72.png', fopen(App::path('/resources/image/72x72.png'), 'r'));
    ...
    public function test_metadata()
    {
        ...
        $path = '72x72.png';
        $this->filesystem->put($path, fopen(App::path('/resources/image/72x72.png'), 'r'));
        $metadata = $this->filesystem->metadata($path);
        $this->assertSame('file', $metadata['type']);
        $this->assertSame($path, $metadata['path']);
        $this->assertSame($this->filesystem->size($path), $metadata['size']);
