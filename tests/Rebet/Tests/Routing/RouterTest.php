    ...
    class RouterTest extends RebetTestCase
    {
        public function setUp()
        {
            ...
            Router::rules('web', function () {
                ...
                Router::get('/method/namespace/different', 'Rebet\\Tests\\Different\\DifferentController@foo');
                
                Router::controller('/controller/short-name', 'RouterTestController');
                Router::controller('/controller/fqcn', RouterTestController::class);
...
namespace Rebet\Tests\Different {
    use Rebet\Routing\Controller;
