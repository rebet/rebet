...
class CollectionTest extends RebetTestCase
{
    ...
    public function testExcept()
    {
        ...
        $this->assertEquals(['first' => 'Taylor'], $data->except(Collection::make(['last', 'email', 'missing']))->all());
    ...
    public function testRandom()
    {
        ...
        $this->assertContains($random[0], $data->all());
    ...
    public function testOnly()
    {
        ...
        $this->assertEquals(['first' => 'Taylor'], $data->only('first', 'missing')->all());
        $this->assertEquals(['first' => 'Taylor'], $data->only(Collection::make(['first', 'missing']))->all());

        $this->assertEquals(['first' => 'Taylor', 'email' => 'taylorotwell@gmail.com'], $data->only(['first', 'email'])->all());
        $this->assertEquals(['first' => 'Taylor', 'email' => 'taylorotwell@gmail.com'], $data->only('first', 'email')->all());
        $this->assertEquals(['first' => 'Taylor', 'email' => 'taylorotwell@gmail.com'], $data->only(Collection::make(['first', 'email']))->all());
    }
    ...
    public function testHigherOrderCollectionMap()
    {
        ...
        $collection = Collection::make([$person1, $person2]);

        $this->assertEquals(['Taylor', 'Yaz'], $collection->map->name->toArray());

        $collection = Collection::make([new TestSupportCollectionHigherOrderItem, new TestSupportCollectionHigherOrderItem]);
