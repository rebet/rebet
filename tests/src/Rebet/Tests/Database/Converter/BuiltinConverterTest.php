...
EOS;
    ...
    {
        $this->setUp();
        $file = fopen(App::structure()->public('/assets/img/72x72.png'), 'r');
        return [
            ...
            [['sqlite', 'mysql', 'mariadb', 'pgsql'], PdoParameter::str('POINT(1 1)'), Expression::of('ST_GeomFromText({val})', 'POINT(1 1)')],
            [['sqlite', 'mysql', 'mariadb', 'pgsql'], PdoParameter::int(1), Expression::of('SUM({val}})', 1)],
            ...
            [['sqlite', 'mysql', 'mariadb', 'pgsql'], PdoParameter::lob($file), $file],
