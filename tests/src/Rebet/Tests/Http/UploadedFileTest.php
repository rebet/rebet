...
class UploadedFileTest extends RebetTestCase
{
    ...
    public function test_getWidth()
    {
        ...
        $this->assertSame(160, (new UploadedFile(App::structure()->public('/assets/img/160x240.png'), '160x240.png'))->getWidth());
    ...
    public function test_getHeight()
    {
        ...
        $this->assertSame(240, (new UploadedFile(App::structure()->public('/assets/img/160x240.png'), '160x240.png'))->getHeight());
